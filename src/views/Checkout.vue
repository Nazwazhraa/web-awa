              ...
              <ul class="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                  ...
                  <li class="flex items-center space-x-3 text-left sm:space-x-4">
                      <a class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-600 text-xs font-semibold text-white ring ring-gray-600 ring-offset-2"
                          href="#">2</a>
                      <span class="font-semibold text-gray-900">Biaya Pengiriman</span>
                  </li>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24"
                      stroke="currentColor" stroke-width="2">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                  ...
                  <li class="flex items-center space-x-3 text-left sm:space-x-4">
                      <a class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-400 text-xs font-semibold text-white"
                          href="#">3</a>
                      <span class="font-semibold text-gray-500">Pembayaran</span>
                  </li>
              </ul>
          </div>
      </div>
  ...
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
          ...
          <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
              <div v-for="product in getCart" :key="product.cart_id"
                  ...
                  <img class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                      src="https://i.pinimg.com/736x/e7/9f/61/e79f6141b5385318377f92050d05542a.jpg"
                      alt="" />
          ...
          <form class="mt-5 grid gap-6">
              <div class="relative">
                  ...
                  <label
                      ...
                      for="radio_1">
                      <img class="w-14 object-contain" src="https://i.pinimg.com/564x/27/33/d4/2733d452329a7a5a73e3922a36e69370.jpg"
                          alt="" />
                      <div class="ml-5">
                          <span class="mt-2 font-semibold">JNT Express</span>
              ...
              <div class="relative">
                  ...
                  <label
                      class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                      for="radio_2">
                      <img class="w-14 object-contain" src="https://i.pinimg.com/736x/cf/9c/18/cf9c18d97b5b7bb116cc99e1c93afcff.jpg"
                          alt="" />
                      <div class="ml-5">
              ...
              <div class="relative">
                  ...
                  <label
                      ...
                      <img class="w-14 object-contain"
                          src="https://png.pngtree.com/png-clipart/20210523/original/pngtree-cash-on-delivery-stamp-black-red-png-image_6328327.png"
                          alt="" />
                      <div class="ml-5 mt-4">
      ...
      <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <div class="">
              ...
              <label for="card-holder" class="mt-4 mb-2 block text-sm font-medium">Nama Lengkap</label>
              <div class="relative">
              ...
              <!-- <label for="card-no" class="mt-4 mb-2 block text-sm font-medium"></label>
              <div class="flex">
                  ...
                  <div class="relative flex-shrink-0 sm:w-7/12">
                      ...
                      <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                          <img class="h-4 w-4 object-contain"
                              src="https://img.freepik.com/free-vector/illustration-indonesia-flag_53876-27131.jpg?q=10&h=200" alt="" />
                      </div>
                  </div>
                  <select type="text" name="billing-state"
                      class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
                      <option value="State">Kota</option>
                  </select>
