            ...
            <div class="lg:flex lg:items-start">
              <div class="lg:order-2 lg:ml-5">
                <div class="max-w-xl overflow-hidden rounded-lg">
                  <img class="h-full w-full max-w-full object-cover" src="https://i.pinimg.com/736x/e7/9f/61/e79f6141b5385318377f92050d05542a.jpg" alt="" />
                </div>
              </div>
              ...
              <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                <div class="flex flex-row items-start lg:flex-col">
                  <button type="button"
                    ...
                    <img class="h-full w-full object-cover" src="https://i.pinimg.com/736x/e7/9f/61/e79f6141b5385318377f92050d05542a.jpg" alt="" />
                  </button>
                  <button type="button"
