<template>
  <br>
  <br><br><br>
    <center><h1 class="mb-2 text-2xl font-black">CONTACT</h1></center>
      ...
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">nazwaazahra128@gmail.com</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://msng.link/o?diimsrzki=ig">@nazwazhraaa</a>
